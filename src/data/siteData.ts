...
export const compliance: { jurisdiction: string; firm: string; responsibleAttorneys: { name: string; barNumber: string }[]; disclaimers: { kind: string; text: string }[] } = data.compliance
...
export const testimonials: { id: number; name: string; initials: string; role: string; rating: number; text: string }[] = data.testimonials
export const topicalEntryGrid = data.topicalEntryGrid
export const trustBadges: { id: number; title: string; tooltip: string; badge: string; href: string }[] = data.trustBadges
